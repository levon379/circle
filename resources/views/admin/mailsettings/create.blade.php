                        ...
                        <form method="post" action="{{ $route }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title"
                                       placeholder="Title" name="title" value="{{old('subject')}}" required>
                            </div>

                            <div class="form-group">
                                <label for="description">Message <strong class="text-danger"> &#42; </strong></label>
                                @error('message')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="description">Type <strong class="text-danger"> &#42; </strong></label>
                                @error('type')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <section>
