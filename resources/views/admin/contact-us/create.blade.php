                        ...
                        <form method="post" action="{{ $route }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title"
                                       placeholder="Title" name="email" value="{{old('email')}}" required>
                            </div>

                            <div class="form-group">
                                <label for="product_desc">Message</label>
                                @error('quote')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea name="message" id="product_desc" cols="30" rows="10" class="form-control" style="resize: none">{{old('message')}}</textarea>
                            </div>
