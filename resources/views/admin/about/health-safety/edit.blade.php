                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form method="post" action="{{ $route."/".$data->id }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="description">Text 2 <strong class="text-danger">
                                        &#42; </strong></label>
                                @error('description')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea name="text2" id="description" cols="30" rows="10" class="form-control"
                                          style="resize: none;" required>{{$data->text2}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="description">Text 3 <strong class="text-danger">
                                        &#42; </strong></label>
                                @error('description')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea name="text3" id="text3" cols="30" rows="10" class="form-control"
                                          style="resize: none;" required>{{$data->text3}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="description">Text 4<strong class="text-danger">
                                        &#42; </strong></label>
                                @error('description')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea name="text4" id="text4" cols="30" rows="10" class="form-control"
                                          style="resize: none;" required>{{$data->text4}}</textarea>
                            </div>
